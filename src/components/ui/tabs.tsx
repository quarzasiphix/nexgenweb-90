...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-md bg-white border border-neutral-200 p-1 text-neutral-600 shadow-sm",
      className
    )}
    {...props}
  />
