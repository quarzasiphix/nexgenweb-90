...
const AboutPage = () => {
  ...
  useEffect(() => {
    document.title = "About Us - ToverNet";
  }, []);
    ...
    <div className="min-h-screen bg-neutral-900">
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="relative py-16 bg-neutral-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-white mb-4">About ToverNet</h1>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2">
                ...
                <div className="space-y-4 text-neutral-300">
                  <p>
                    At ToverNet, our mission is to empower businesses with innovative technology solutions that drive growth, efficiency, and competitive advantage in the digital landscape.
                  </p>
                  <p>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">Why Choose ToverNet</h2>
              <p className="text-lg text-neutral-300 max-w-2xl mx-auto">
